 ...
 */
export async function openDiffView(filePath, model, diffContext, renderMime, isText = false) {
    if (isDiffSupported(filePath) || isText) {
        ...
        showDialog({
            ...
            body: `Diff is not supported for ${PathExt.extname(filePath).toLocaleLowerCase()} files.`
        });
    }
}
//# sourceMappingURL=DiffWidget.js.map